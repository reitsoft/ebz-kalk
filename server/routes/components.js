...
const { Block, Component, Article, Component_Article, Pricetype } = require("../models");
...
router.get("/:id", (req, res) => {
  ...
  Component.findByPk(req.params.id, {
    include: [
      { model: Block, through: { attributes: [] } },
      { model: Article, through: { attributes: [] }, include: [Pricetype] },
    ],
  })
    .then((component) => {
      res.status(200).json({
